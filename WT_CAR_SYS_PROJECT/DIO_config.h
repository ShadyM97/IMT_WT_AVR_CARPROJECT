...
/* PORT A */
#define DIO_PIN_NUM_A0_DIR		DIO_INPUT // SPEED_POT
#define DIO_PIN_NUM_A1_DIR		DIO_INPUT // STEERING_POT
...
#define DIO_PIN_NUM_C4_DIR		DIO_OUTPUT // SS
#define DIO_PIN_NUM_C5_DIR		DIO_OUTPUT // MOSI
#define DIO_PIN_NUM_C6_DIR		DIO_INPUT  // MISO
#define DIO_PIN_NUM_C7_DIR		DIO_OUTPUT // SCK
