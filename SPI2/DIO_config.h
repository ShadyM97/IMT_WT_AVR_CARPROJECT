...
#define DIO_PIN_NUM_B4_DIR		DIO_INPUT // SS
#define DIO_PIN_NUM_B5_DIR		DIO_INPUT // MOSI
#define DIO_PIN_NUM_B6_DIR		DIO_OUTPUT // MISO
#define DIO_PIN_NUM_B7_DIR		DIO_INPUT // SCK
